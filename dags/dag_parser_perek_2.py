...
with DAG(
    ...
    category_parser >> products_parser >> to_postgre >> insert_dirty_products_perek >> insert_pure_products_perek >> insert_pure_perek_weights
    to_postgre >> content_parser >> insert_dirty_products_perek_composition >> insert_pure_products_perek_composition >> insert_pure_perek_weights
    insert_pure_perek_weights >> fast_perek_datamart
    insert_pure_perek_weights >> long_perek_datamart
    create_sql_function
